...
import org.boxer.iron.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_iron_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_iron_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_iron_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_iron_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_iron_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_iron_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_iron_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_iron_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_iron_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_iron_colorActive, colorActive);
                titleColorActive = ta.getColor(R.styleable.BubbleToggleView_iron_titleColorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_iron_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_iron_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_iron_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_iron_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_iron_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
